        ...
        <section className="i-miei-servizi" id='Servizi'>
            ...
            <div className="row g-4 py-2 px-5 row-cols-1 row-cols-lg-3" id="servizi-icone">
                <div className="feature col">
                    <div className="feature-icon d-inline-flex align-items-center justify-content-center text-center bg bg-gradient fs-5 mb-5 icona">
                ...
                <div className="feature col">
                    <div className="feature-icon d-inline-flex align-items-center justify-content-center text-center text-dark bg-gradient fs-5 mb-5 icona">
                        <BiBook size="3em" />
                    </div>
                    <h3 className="fs-2 text-body-emphasis roboto-font" style={{ color: '#8C83B0' }}>Orientamento professionale</h3>
